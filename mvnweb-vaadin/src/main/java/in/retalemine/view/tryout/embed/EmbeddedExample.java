package in.retalemine.view.tryout.embed;
...
public class EmbeddedExample extends CustomComponent {

	private static final long serialVersionUID = 8202370902254347806L;
	...
	public void flash(VerticalLayout layout) {
		...
		Flash flash = new Flash(null, new ThemeResource("img/vaadin_spin.swf"));
