...
public class SubWindowExample extends CustomComponent {

	private static final long serialVersionUID = -1561740735029043371L;
	private static final Logger logger = LoggerFactory
			.getLogger(SubWindowExample.class);

	VerticalLayout layout = new VerticalLayout();
	String context;

	public SubWindowExample(String context) {
		logger.info("const");
		init(context);
	}
	...
	static public String closeDescription = "<h1>Closing Sub-Windows</h1>\n"
		...
		sub.addCloseListener(new CloseListener() {
			...
			public void windowClose(CloseEvent e) {
				layout.addComponent(new Label("Sub-window of "
						+ UI.getCurrent().getCaption() + " was closed"));
			}
		});
