package in.retalemine.view.tryout.form;
...
public class FieldGroupExample extends CustomComponent {
	private static final long serialVersionUID = -6235574698344484522L;

	public FieldGroupExample(String context) {
	...
	void basic(final VerticalLayout layout) {
		...
		nameField.addTextChangeListener(new FieldEvents.TextChangeListener() {
	...
	void multipage(final VerticalLayout layout) {
		...
		class MyTabbedForm extends TabSheet implements
